...
### Upload Data
Let's upload more data again. This time, upload the data from [US Public Assistance for Women and Children](https://github.com/papaludwig/splunk-boot-camp/raw/master/data/sub-est2016_all.csv).

### Upload the Lookups Data
Let's upload the lookups CSV data manually to Splunk.

- [Download the "States" file](https://github.com/papaludwig/splunk-boot-camp/raw/master/data/sub-est2016_all_states.csv)
