...
- The automatically-generated search MAY NOT show all of the available syslog entries, since the value for `host=` probably doesn't reflect all of the available values. Try removing any `host= ` filters to fix the query... your instructor can explain why this is neessary.
