...
But first, let's upload more data again. Splunk can ingest either the zipped archive or the uncompressed CSV files directly. Download [google-play-store-apps.zip](../data/google-play-store-apps.zip) if ZIP downloads work in your environment. If ZIP downloads are blocked, download both [googleplaystore.csv](https://github.com/papaludwig/splunk-boot-camp/raw/master/data/googleplaystore.csv) and [googleplaystore_user_reviews.csv](https://github.com/papaludwig/splunk-boot-camp/raw/master/data/googleplaystore_user_reviews.csv) instead. You'll need both CSV files to complete this lab.
